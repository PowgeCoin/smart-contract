...
https://t.me/powgecoin

https://twitter.com/powgecoin
...
contract powgecoin is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("powgecoin", "POWGE") {
    ...
    function powerOfDoge() external onlyOwner {
      maxTransactionAmount = 20_000_000 * 1e18;
      maxWallet = 20_000_00 * 1e18;
